...
export const AddClusterModal: React.FC<AddClusterModalProps> = ({ onClose, onCreate }) => {
      ...
      <div className="bg-gray-50 rounded-lg shadow-xl w-full max-w-lg border border-gray-300" onClick={e => e.stopPropagation()}>
        <div className="flex justify-between items-center p-4 border-b border-gray-200 bg-white rounded-t-lg">
          <div className="flex items-center">
            ...
            <h2 className="text-lg font-semibold text-gray-800">Add Cluster</h2>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="space-y-5">
            <div>
              <label className="block text-sm font-medium text-gray-600 mb-1">Cluster Name</label>
              <input
                type="text"
                value={name}
